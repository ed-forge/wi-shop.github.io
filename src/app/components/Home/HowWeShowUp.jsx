            ...
            <div className="container mx-auto max-w-7xl px-4 md:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
                    ...
                    <div className="flex gap-6">
                        ...
                        <div>
                            <h3 className="text-white text-xl font-medium mb-3">Architect First. Build Second.</h3>
                    ...
                    <div className="flex gap-6">
                        ...
                        <div>
                            <h3 className="text-white text-xl font-medium mb-3">Zero Vanity Metrics.</h3>
                            <p className="text-red-100/60 text-base leading-relaxed">
                    ...
                    <div className="flex gap-6">
                        ...
                        <div>
                            <h3 className="text-white text-xl font-medium mb-3">Ship and Iterate.</h3>
                            <p className="text-red-100/60 text-base leading-relaxed">
                    ...
                    <div className="flex gap-6">
                        ...
                        <div>
                            <h3 className="text-white text-xl font-medium mb-3">Transparent Partnerships.</h3>
                            <p className="text-red-100/60 text-base leading-relaxed">
