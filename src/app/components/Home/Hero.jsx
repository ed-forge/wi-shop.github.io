        ...
        <section className='relative min-h-[90vh] flex items-center bg-[#fdfaf6] dark:bg-black overflow-hidden transition-colors duration-300'>
            <div className='container mx-auto px-4 md:px-8 max-w-7xl relative pt-32 pb-20 lg:pt-40 lg:pb-28 flex flex-col lg:flex-row gap-16 items-center'>
                ...
                <div className='flex-[7] text-left flex flex-col'>
                    ...
                    <h1 className='text-[3.5rem] md:text-[5.5rem] leading-[1.05] font-thin tracking-tight text-neutral-900 dark:text-white mb-8'>
                    ...
                    <div className='flex flex-wrap items-center gap-4'>
                        <Link href="#contact" className='inline-flex shrink-0 items-center gap-2 justify-center whitespace-nowrap bg-red-900 text-white hover:bg-red-800 dark:bg-red-700 dark:hover:bg-red-600 rounded-full px-8 py-4 text-sm font-thin shadow-md hover:shadow-lg transition-all hover:-translate-y-0.5 group'>
                            Book a Clarity Session
                            <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                        </Link>
                        <Link href="#contact" className='inline-flex shrink-0 items-center justify-center whitespace-nowrap text-red-900 dark:text-red-400 border border-red-900/20 dark:border-red-400/20 hover:border-red-900/50 dark:hover:border-red-400/50 hover:bg-red-50 dark:hover:bg-red-950 rounded-full px-8 py-4 text-sm font-thin transition-all group'>
                        ...
                        <Slider {...settings} >
                            {sliderItems.map((item, index) => (
                                <div key={index} className='hover:bg-red-900 dark:hover:bg-red-800 hover:text-white dark:hover:text-white p-6 border-b border-neutral-100 dark:border-neutral-800 transition-colors cursor-pointer group'>
                                    <h3 className='text-lg font-thin text-center text-neutral-600 dark:text-neutral-400 group-hover:text-white transition-colors'>{item}</h3>
                                </div>
                            ))}
                        </Slider>
                    </div>
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
                <span className="text-[0.6875rem] tracking-[0.2em] uppercase text-neutral-500 dark:text-neutral-600 font-thin">Scroll</span>
